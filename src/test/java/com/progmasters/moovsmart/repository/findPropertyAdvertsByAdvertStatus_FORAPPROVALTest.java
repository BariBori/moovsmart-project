...
public class findPropertyAdvertsByAdvertStatus_FORAPPROVALTest {
    ...
    @Test
    public void testSaveAndFindAllWithOneAvert() {
        ...
        List<PropertyAdvert> propertyList = advertRepository.findPropertyAdvertsByAdvertStatus_FORAPPROVAL();
        assertEquals(1, propertyList.size());
    }

    @Test
    public void testSaveAndFindAllWithTwoAdverts() {
        PropertyAdvertFormData propertyAdvertFormData = new PropertyAdvertFormData();
        propertyAdvertFormData.setPrice(20.0);
        propertyAdvertFormData.setId(300000);
        propertyAdvertFormData.setPropertyType(PropertyType.FLAT);
    ...
    @Test
    public void testSaveAndFindAllWithNoAdvert() {
        List<PropertyAdvert> result = advertRepository.findAll();
        assertEquals(0, result.size());
    }

    @Test
    public void testSaveAndFindAllWithACTIVE() {
        PropertyAdvertFormData propertyAdvertFormData = new PropertyAdvertFormData();
        propertyAdvertFormData.setPrice(20.0);
        propertyAdvertFormData.setId(300000);
        propertyAdvertFormData.setPropertyType(PropertyType.FLAT);
        ...
        if (tempUser.isPresent()) {
            User actualUser = tempUser.get();
            PropertyAdvert propertyAdvert = new PropertyAdvert(propertyAdvertFormData, actualUser);
            propertyAdvert.setAdvertStatus(AdvertStatusType.ACTIVE);
            advertRepository.save(propertyAdvert);
        }
        List<PropertyAdvert> propertyList = advertRepository.findPropertyAdvertsByAdvertStatus_FORAPPROVAL();
    ...
    @Test
    public void testSavedAndFindAllWithARCHIVE() {
        PropertyAdvertFormData propertyAdvertFormData = new PropertyAdvertFormData();
        propertyAdvertFormData.setPrice(20.0);
        propertyAdvertFormData.setId(300000);
        propertyAdvertFormData.setPropertyType(PropertyType.FLAT);
    ...
    @Test
    public void testSaveAndFindAllWithBANNED() {
        PropertyAdvertFormData propertyAdvertFormData = new PropertyAdvertFormData();
        propertyAdvertFormData.setPrice(20.0);
        propertyAdvertFormData.setId(300000);
        propertyAdvertFormData.setPropertyType(PropertyType.FLAT);
        ...
        if (tempUser.isPresent()) {
            User actualUser = tempUser.get();
            PropertyAdvert propertyAdvert = new PropertyAdvert(propertyAdvertFormData, actualUser);
            propertyAdvert.setAdvertStatus(AdvertStatusType.BANNED);
            advertRepository.save(propertyAdvert);
        }
        List<PropertyAdvert> propertyList = advertRepository.findPropertyAdvertsByAdvertStatus_FORAPPROVAL();
        assertEquals(0, propertyList.size());
    ...
    @Test
    public void testSaveAndFindAllWithTwoAdvertsDesc() {
        PropertyAdvertFormData propertyAdvertFormData = new PropertyAdvertFormData();
        propertyAdvertFormData.setPrice(20.0);
        propertyAdvertFormData.setId(300000);
        propertyAdvertFormData.setPropertyType(PropertyType.FLAT);
        ...
        PropertyAdvertFormData propertyAdvertFormData1 = new PropertyAdvertFormData();
        propertyAdvertFormData1.setPrice(25.0);
        propertyAdvertFormData1.setId(300000);
        propertyAdvertFormData1.setPropertyType(PropertyType.FLAT);
        propertyAdvertFormData1.setPropertyConditionType(PropertyConditionType.NEW);
        propertyAdvertFormData1.setParkingType(ParkingType.STREET);
